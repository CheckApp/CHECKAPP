...
class Atualizar(View):
    def get(self, *args, **kwargs):
        return HttpResponse('redirecionando para a view Atualizar')

class Cadastrar(View):
    def get(self, *args, **kwargs):
        return HttpResponse('redirecionando para a view cadastrar')

class Acesso(View):
    template_name = 'perfil/acesso.html'
